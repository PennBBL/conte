...
path=`ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/ratings/pre`
...
echo "Subject,Timepoint,Answer.quest29,Face.quest29,Answer.quest30,Face.quest30,Answer.quest31,Face.quest31,Answer.quest32,Face.quest32,Answer.quest37,Face.quest37,Answer.quest38,Face.quest38,Answer.quest39,Face.quest39,Answer.quest40,Face.quest40" > //data/joy/BBL/studies/conte/subjectData/ratingsPre/pre_ratings_"$date".csv
done

#for every individual's ratings file, append to the aggregate csv file
for k in $( ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/ratings/pre/*_pre_ratings_data.csv ) ;do
tail -1 "$k" | cut -d "," -f 2-100 >> data/joy/BBL/studies/conte/subjectData/ratingsPre/pre_ratings_"$date".csv
done
