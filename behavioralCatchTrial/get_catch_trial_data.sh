...
mkdir /data/joy/BBL/studies/conte/rawData/$bblid/*$scanid/associated_files/behavioralQa
mkdir /data/joy/BBL/studies/conte/rawData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials
fi

#create a variable for the catch trial directory for each subject
path=`ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials`
...
/import/monstrum2/Applications/R3.2.3/bin/R --file=/data/joy/BBL/projects/conteReproc2017/behavioralCatchTrial/parse_logfile_catch_trial_run1.R --slave --args "$logfile_run1" "$scanid" "$path"

/import/monstrum2/Applications/R3.2.3/bin/R --file=/data/joy/BBL/projects/conteReproc2017/behavioralCatchTrial/parse_logfile_catch_trial_run2.R --slave --args "$logfile_run2" "$scanid" "$path"
...
for k in $( ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials/*_run1_summary_response_trial_data.csv ) ;do
...
for j in $( ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials/*_run2_summary_response_trial_data.csv ) ;do
...
for l in $( ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials/*_run1_response_type_table_data.csv ) ;do
tail -1 "$l" | cut -d "," -f 2-8 >> /data/joy/BBL/studies/conte/subjectData/behavioralCatchTrial/run1_response_type_table_data_"$date".csv
done

for k in $( ls -d /data/joy/BBL/studies/conte/processedData/$bblid/*$scanid/associated_files/behavioralQa/catchTrials/*_run2_response_type_table_data.csv ) ;do
