...
/data/joy/BBL/projects/conteReproc2017/freesurfer/aparc.stats.meanthickness.totalarea.sh $slist $output_dir $SUBJECTS_DIR 
...
/data/joy/BBL/projects/conteReproc2017/freesurfer/cnr_euler_number_calculation.sh $slist $SUBJECTS_DIR $output_dir

##### 5) Flag subjects based on whether they are an outlier (>2 SD) on several measures##### 
/share/apps/R/R-3.1.1/bin/R --slave --file=/data/joy/BBL/projects/conteReproc2017/freesurfer/flag_outliers.R --args $output_dir

##### 6) Flag  (gray/csf flag, gray/white flag, euler number flag, number outliers rois thickness flag, total outliers)##### 
/share/apps/R/R-3.1.1/bin/R --slave --file=/data/joy/BBL/projects/conteReproc2017/freesurfer/cnr_euler_qa.R --args $output_dir
